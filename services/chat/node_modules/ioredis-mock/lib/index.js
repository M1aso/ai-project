...
var __export = (target, all) => {
  ...
  return target;
}, __toESM = (module2, isNodeMode) => __reExport(__markAsModule(__defProp(module2 != null ? __create(__getProtoOf(module2)) : {}, "default", !isNodeMode && module2 && module2.__esModule ? { get: () => module2.default, enumerable: !0 } : { value: module2, enumerable: !0 })), module2);
...
var require_lodash = __commonJS({
  "node_modules/lodash.shuffle/index.js"(exports2, module2) {
    ...
    }(), funcToString = funcProto.toString, hasOwnProperty = objectProto.hasOwnProperty, objectToString = objectProto.toString, reIsNative = RegExp("^" + funcToString.call(hasOwnProperty).replace(reRegExpChar, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Symbol2 = root.Symbol, iteratorSymbol = Symbol2 ? Symbol2.iterator : void 0, propertyIsEnumerable = objectProto.propertyIsEnumerable, nativeFloor = Math.floor, nativeKeys = overArg(Object.keys, Object), nativeRandom = Math.random, DataView = getNative(root, "DataView"), Map2 = getNative(root, "Map"), Promise2 = getNative(root, "Promise"), Set2 = getNative(root, "Set"), WeakMap2 = getNative(root, "WeakMap"), dataViewCtorString = toSource(DataView), mapCtorString = toSource(Map2), promiseCtorString = toSource(Promise2), setCtorString = toSource(Set2), weakMapCtorString = toSource(WeakMap2);
...
var require_lodash4 = __commonJS({
  "node_modules/lodash.orderby/index.js"(exports2, module2) {
    ...
    var arrayProto = Array.prototype, funcProto = Function.prototype, objectProto = Object.prototype, coreJsData = root["__core-js_shared__"], maskSrcKey = function() {
      var uid = /[^.]+$/.exec(coreJsData && coreJsData.keys && coreJsData.keys.IE_PROTO || "");
      return uid ? "Symbol(src)_1." + uid : "";
    }(), funcToString = funcProto.toString, hasOwnProperty = objectProto.hasOwnProperty, objectToString = objectProto.toString, reIsNative = RegExp("^" + funcToString.call(hasOwnProperty).replace(reRegExpChar, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Symbol2 = root.Symbol, Uint8Array2 = root.Uint8Array, propertyIsEnumerable = objectProto.propertyIsEnumerable, splice = arrayProto.splice, nativeKeys = overArg(Object.keys, Object), DataView = getNative(root, "DataView"), Map2 = getNative(root, "Map"), Promise2 = getNative(root, "Promise"), Set2 = getNative(root, "Set"), WeakMap2 = getNative(root, "WeakMap"), nativeCreate = getNative(Object, "create"), dataViewCtorString = toSource(DataView), mapCtorString = toSource(Map2), promiseCtorString = toSource(Promise2), setCtorString = toSource(Set2), weakMapCtorString = toSource(WeakMap2), symbolProto = Symbol2 ? Symbol2.prototype : void 0, symbolValueOf = symbolProto ? symbolProto.valueOf : void 0, symbolToString = symbolProto ? symbolProto.toString : void 0;
    function Hash(entries) {
      var index = -1, length = entries ? entries.length : 0;
      for (this.clear(); ++index < length; ) {
        var entry = entries[index];
...
// src/command.js
var import_command = __toESM(require("ioredis/built/command")), import_standard_as_callback = __toESM(require("standard-as-callback"));
...
var { lua: lua2, to_luastring: toLuaString2 } = import_fengari2.default, defineRedisObject = (vm) => (fn) => {
  ...
  try {
    ...
    result = commands_exports[name].bind(this)(...args.slice(1));
  } catch (err) {
    if (!returnError)
      throw err;
...
function xadd(stream, id, ...args) {
  if (!stream || !id || args.length === 0 || (args.includes("~") ? args.length < 4 : args.length % 2 !== 0))
    throw new Error("ERR wrong number of arguments for 'xadd' command");
  this.data.has(stream) || this.data.set(stream, []);
  let eventId = `${id === "*" ? this.data.get(stream).length + 1 : id}-0`, list = this.data.get(stream);
  ...
  return this.data.set(`stream:${stream}:${eventId}`, { polled: !1 }), this.data.set(stream, list.concat([[`${eventId}`, [...args]]])), `${eventId}`;
}
...
var import_array_prototype = __toESM(require("array.prototype.flatmap")), import_lodash6 = __toESM(require_lodash4());
function zpopmax(key, count = 1) {
  ...
  return ordered.forEach((it) => {
    map.delete(it.value);
  }), this.data.set(key, map), (0, import_array_prototype.default)(ordered, (it) => [it.value, it.score]);
}

// src/commands/zpopmin.js
var import_array_prototype2 = __toESM(require("array.prototype.flatmap")), import_lodash7 = __toESM(require_lodash4());
function zpopmin(key, count = 1) {
  ...
  return ordered.forEach((it) => {
    map.delete(it.value);
  }), this.data.set(key, map), (0, import_array_prototype2.default)(ordered, (it) => [it.value, it.score]);
}

// src/commands/zrange.js
var import_array_prototype3 = __toESM(require("array.prototype.flatmap")), import_lodash8 = __toESM(require_lodash4());
function zrange(key, s, e, withScores) {
  ...
  return typeof withScores == "string" && withScores.toUpperCase() === "WITHSCORES" ? (0, import_array_prototype3.default)(ordered, (it) => [it.value, `${it.score}`]) : ordered.map((it) => it.value);
}

// src/commands/zrangebyscore.js
var import_array_prototype4 = __toESM(require("array.prototype.flatmap")), import_lodash9 = __toESM(require_lodash4());
function zrangebyscore(key, inputMin, inputMax, ...args) {
  ...
  if (withScores)
    return limit !== null && (ordered = offsetAndLimit(ordered, offset, limit)), (0, import_array_prototype4.default)(ordered, (it) => [it.value, it.score]);
...
var import_array_prototype5 = __toESM(require("array.prototype.flatmap")), import_lodash11 = __toESM(require_lodash4());
function zrevrangebyscore(key, inputMax, inputMin, ...args) {
  ...
  if (withScores)
    return limit !== null && (ordered = offsetAndLimit(ordered, offset, limit)), (0, import_array_prototype5.default)(ordered, (it) => [it.value, it.score]);
  let results = ordered.map((it) => it.value);
  return limit !== null ? offsetAndLimit(results, offset, limit) : results;
}
...
var import_stream = require("stream"), ReadableScan = class extends import_stream.Readable {
  constructor(scanCommand, opt = {}) {
    super({ objectMode: !0 });
    this._scanCommand = scanCommand, this._cursor = 0, this.opt = opt, this._drained = !1;
  }
  _callScan() {
...
var defaultOptions = {
  ...
  constructor(...args) {
    super();
    this.batch = void 0, this.connected = !1, this.subscriberMode = !1, this.customCommands = {}, this.shaScripts = {};
  ...
  createConnectedClient(options = {}) {
    let mock = new RedisMock(options);
    return mock.expires = typeof options.keyPrefix == "string" ? this.expires.withKeyPrefix(options.keyPrefix) : this.expires, mock.data = typeof options.keyPrefix == "string" ? this.data.withKeyPrefix(options.keyPrefix) : this.data, mock.channels = this.channels, mock.patternChannels = this.patternChannels, mock;
  }
  duplicate() {
...
RedisMock.Cluster = class extends RedisMock {
  constructor(nodesOptions) {
    super();
    this.nodes = [], nodesOptions.forEach((options) => this.nodes.push(new RedisMock(options)));
  }
};
